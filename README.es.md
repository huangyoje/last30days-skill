...
| **Weibo (微博)** | Microblog chino. Publicaciones de la búsqueda móvil (综合 + 实时) filtradas por relevancia. Gratis, sin clave de API — obtiene un pase de visitante en la primera llamada; `WEIBO_COOKIE` opcional para límites de tasa más altos. |
