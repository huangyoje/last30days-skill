...
| **Weibo (微博)** | Microblog chinois. Statuts de la recherche mobile (综合 + 实时) filtrés par pertinence. Gratuit, sans clé API — obtient un pass visiteur au premier appel ; `WEIBO_COOKIE` optionnel pour des limites de taux plus élevées. |
